...
import mk.ukim.finki.emt.usermanagement.auth.JWTAuthenticationEntryPoint;
import mk.ukim.finki.emt.usermanagement.auth.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(csrf -> csrf.disable())
                .authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests.
                        ...
                        requestMatchers("/api/auth/get-user").permitAll().
